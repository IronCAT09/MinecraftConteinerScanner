...
// 64 * 27 = 1728 (обычные предметы), 16 * 27 = 432 (стак 16: жемчуг, снежки и т.д.),
// 1 * 27 = 27 (нестакающиеся: вёдра, доспехи, инструменты и т.д.).
export const FULL_SHULKER_COUNTS = [1728, 432, 27];
